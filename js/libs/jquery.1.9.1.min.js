(function (r, n) {
    ...
    function Ta(a, b, d, e) {
        if (c.acceptData(a)) {
            var f = c.expando, g = "string" === typeof b, h = a.nodeType, k = h ? c.cache : a, l = h ? a[f] : a[f] && f;
    ...
    function Ua(a, b, d) {
        if (c.acceptData(a)) {
            var e, f, g, h = a.nodeType, k = h ? c.cache : a, l = h ? a[c.expando] : c.expando;
            if (k[l]) {
    ...
    function Va(a, b, d) {
        if (d === n && 1 === a.nodeType)if (d = "data-" + b.replace(Rb, "-$1").toLowerCase(), d = a.getAttribute(d), "string" === typeof d) {
            try {
    ...
    function bb(a, b) {
        if (1 === b.nodeType && c.hasData(a)) {
            ...
            if (h)for (d in delete g.handle,
                g.events = {}, h)for (e = 0, f = h[d].length; e < f; e++)c.event.add(b, d, h[d][e]);
            g.data && (g.data = c.extend({}, g.data))
        }
    }

    function A(a, b) {
        var d, e, f = 0, g = typeof a.getElementsByTagName !== y ? a.getElementsByTagName(b || "*") : typeof a.querySelectorAll !== y ? a.querySelectorAll(b || "*") : n;
        if (!g)for (g = [], d = a.childNodes || a; null != (e = d[f]); f++)!b || c.nodeName(e, b) ? g.push(e) : c.merge(g, A(e, b));
    ...
    function ib(a, b, d) {
        var e = !0, f = "width" === b ? a.offsetWidth : a.offsetHeight, g = R(a), h = c.support.boxSizing && "border-box" === c.css(a, "boxSizing", !1, g);
        if (0 >= f || null == f) {
            f = S(a, b, g);
    ...
    function Aa(a, b, d, e) {
        ...
        }); else if (d || "object" !== c.type(b))e(a, b); else for (f in b)Aa(a +
            "[" + f + "]", b[f], d, e)
    }
    ...
    function pb(a, b, d) {
        var e, f = 0, g = ja.length, h = c.Deferred().always(function () {
            ...
            h.resolveWith(a, [l]);
            return!1
        }, l = h.promise({elem: a, props: c.extend({}, b), opts: c.extend(!0, {specialEasing: {}}, d), originalProperties: b, originalOptions: d, startTime: T || ob(), duration: d.duration, tweens: [], createTween: function (b, d) {
            var e = c.Tween(a, l.opts, b, d, l.opts.specialEasing[b] || l.opts.easing);
            l.tweens.push(e);
            return e
        }, stop: function (b) {
            var c =
                0, d = b ? l.tweens.length : 0;
            if (e)return this;
        ...
        d = l.props;
        for (Zb(d, l.opts.specialEasing); f < g; f++)if (b = ja[f].call(l, a, d, l.opts))return b;
        Yb(l, d);
    ...
    function Zb(a, b) {
        var d, e, f, g, h;
        for (f in a)if (e =
            c.camelCase(f), g = b[e], d = a[f], c.isArray(d) && (g = d[1], d = a[f] = d[0]), f !== e && (a[e] = d, delete a[f]), (h = c.cssHooks[e]) && "expand"in h)for (f in d = h.expand(d), delete a[e], d)f in a || (a[f] = d[f], b[f] = g); else b[e] = g
    }
    ...
    var la, rb, y = typeof n,
        p = r.document, $b = r.location, ac = r.jQuery, bc = r.$, ma = {}, G = [], sb = G.concat, Da = G.push, U = G.slice, tb = G.indexOf, cc = ma.toString, ga = ma.hasOwnProperty, Ea = "1.9.1".trim, c = function (a, b) {
            return new c.fn.init(a, b, rb)
        }, na = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, O = /\S+/g, dc = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ec = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, ub = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, fc = /^[\],:{}\s]*$/, gc = /(?:^|:|,)(?:\s*\[)+/g, hc = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, ic = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g,
        jc = /^-ms-/, kc = /-([\da-z])/gi, lc = function (a, b) {
    ...
    c.fn = c.prototype = {jquery: "1.9.1", constructor: c, init: function (a, b, d) {
        ...
        if ("string" === typeof a) {
            ...
            if (e[1]) {
                if (b = b instanceof c ? b[0] : b, c.merge(this, c.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : p, !0)), ub.test(e[1]) && c.isPlainObject(b))for (e in b)if (c.isFunction(this[e]))this[e](b[e]); else this.attr(e, b[e])
            } else {
    ...
    c.extend = c.fn.extend = function () {
        var a, b, d,
            e, f, g = arguments[0] || {}, h = 1, k = arguments.length, l = !1;
        "boolean" === typeof g && (l = g, g = arguments[1] || {}, h = 2);
        "object" === typeof g || c.isFunction(g) || (g = {});
        k === h && (g = this, --h);
        for (; h < k; h++)if (null != (f = arguments[h]))for (e in f)a = g[e], d = f[e], g !== d && (l && d && (c.isPlainObject(d) || (b = c.isArray(d))) ? (b ? (b = !1, a = a && c.isArray(a) ? a : []) : a = a && c.isPlainObject(a) ? a : {}, g[e] = c.extend(l, a, d)) : d !== n && (g[e] = d));
        return g
    };
    c.extend({noConflict: function (a) {
        ...
        holdReady: function (a) {
            ...
            e = va(a);
            if (c)if (e)for (; f < g && (e = b.apply(a[f], c), !1 !== e); f++); else for (f in a) {
                if (e = b.apply(a[f], c), !1 === e)break
            } else if (e)for (; f < g && (e = b.call(a[f], f, a[f]), !1 !== e); f++); else for (f in a)if (e = b.call(a[f], f, a[f]), !1 === e)break;
            return a
        ...
        inArray: function (a, b, c) {
            ...
            if ("number" === typeof c)for (; f < c; f++)a[e++] = b[f]; else for (; b[f] !== n;)a[e++] = b[f++];
            a.length = e;
            return a
        }, grep: function (a, b, c) {
            ...
            if (va(a))for (; f < g; f++)e = b(a[f], f, c), null !=
                e && (h[h.length] = e); else for (f in a)e = b(a[f], f, c), null != e && (h[h.length] = e);
            return sb.apply([], h)
            ...
            if ("object" === c.type(d))for (k in f = !0, d)c.access(a, b, k, d[k], !0, g, h); else if (e !== n && (f = !0, c.isFunction(e) || (h = !0),
                q && (h ? (b.call(a, e), b = null) : (q = b, b = function (a, b, d) {
                    return q.call(c(a), d)
                })), b))for (; k < l; k++)b(a[k], d, h ? e : e.call(a[k], k, b(a[k], d)));
            return f ? a : q ? b.call(a) : l ? b(a[0], d) : g
        }, now: function () {
            return(new Date).getTime()
        }});
    c.ready.promise = function (a) {
        if (!la)if (la = c.Deferred(), "complete" === p.readyState)setTimeout(c.ready); else if (p.addEventListener)p.addEventListener("DOMContentLoaded", L, !1), r.addEventListener("load", L, !1); else {
    ...
    c.extend({Deferred: function (a) {
        var b = [
            ...
            return c.Deferred(function (d) {
                c.each(b, function (b, l) {
                    var q = l[0], s = c.isFunction(a[b]) && a[b];
                    f[l[1]](function () {
                        var a = s && s.apply(this, arguments);
                        if (a && c.isFunction(a.promise))a.promise().done(d.resolve).fail(d.reject).progress(d.notify); else d[q + "With"](this === e ?
        ...
        var b = 0, d = U.call(arguments), e = d.length, f = 1 !== e || a && c.isFunction(a.promise) ? e : 0, g = 1 === f ? a : c.Deferred(),
            h = function (a, b, c) {
                return function (d) {
                    b[a] = this;
        ...
        if (1 < e)for (k = Array(e), l = Array(e), q = Array(e); b < e; b++)d[b] && c.isFunction(d[b].promise) ? d[b].promise().done(h(b, q, d)).fail(g.reject).progress(h(b, l, k)) : --f;
        f || g.resolveWith(q, d);
        return g.promise()
    }});
    c.support = function () {
        ...
        a = {getSetAttribute: "t" !== k.className, leadingWhitespace: 3 === k.firstChild.nodeType, tbody: !k.getElementsByTagName("tbody").length, htmlSerialize: !!k.getElementsByTagName("link").length, style: /top/.test(d.getAttribute("style")), hrefNormalized: "/a" === d.getAttribute("href"),
        ...
        for (h in{submit: !0, change: !0, focusin: !0})k.setAttribute(d =
    ...
    c.extend({cache: {},
        expando: "jQuery" + ("1.9.1" + Math.random()).replace(/\D/g, ""), noData: {embed: !0, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: !0}, hasData: function (a) {
    ...
    var Z, wb, Fa = /[\t\r\n]/g, mc = /\r/g, nc = /^(?:input|select|textarea|button|object)$/i,
        oc = /^(?:a|area)$/i, xb = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i, Ga = /^(?:checked|selected)$/i, B = c.support.getSetAttribute, Ha = c.support.input;
    c.fn.extend({attr: function (a, b) {
        ...
        if (b)for (b = (a || "").match(O) || []; h < k; h++)if (d = this[h], e = 1 === d.nodeType && (d.className ? (" " + d.className + " ").replace(Fa, " ") : " ")) {
        ...
        return c.isFunction(a) ? this.each(function (d) {
            ...
            if ("string" === d)for (var f, g = 0, h = c(this), k = b, l = a.match(O) || []; f = l[g++];)k = e ? k : !h.hasClass(f), h[k ? "addClass" : "removeClass"](f); else if (d === y || "boolean" === d)this.className && c._data(this, "__className__", this.className), this.className = this.className || !1 === a ? "" : c._data(this, "__className__") || ""
        })
    }, hasClass: function (a) {
        a = " " + a + " ";
        for (var b = 0, c = this.length; b < c; b++)if (1 === this[b].nodeType && 0 <= (" " + this[b].className + " ").replace(Fa, " ").indexOf(a))return!0;
        return!1
    },
        val: function (a) {
            var b, d, e, f = this[0];
    ...
    c.extend({valHooks: {option: {get: function (a) {
        ...
        if (a && 3 !== f && 8 !== f && 2 !== f) {
            ...
            if (d !== n)if (null === d)c.removeAttr(a, b); else {
        ...
        if (g && 1 === a.nodeType)for (; d = g[f++];)e = c.propFix[d] || d, xb.test(d) ? !B && Ga.test(d) ? a[c.camelCase("default-" + d)] = a[e] = !1 : a[e] = !1 : c.attr(a, d, ""), a.removeAttribute(B ? d : e)
    ...
    Ha && B || (c.attrHooks.value = {get: function (a, b) {
        var d = a.getAttributeNode(b);
        return c.nodeName(a, "input") ? a.defaultValue : d && d.specified ? d.value : n
    }, set: function (a, b, d) {
        if (c.nodeName(a, "input"))a.defaultValue = b; else return Z && Z.set(a, b, d)
    }});
    B || (Z = c.valHooks.button = {get: function (a, b) {
    ...
    }}, c.attrHooks.contenteditable = {get: Z.get, set: function (a, b, c) {
        Z.set(a, "" === b ? !1 : b, c)
    ...
    var Ia = /^(?:input|select|textarea)$/i, pc = /^key/, qc = /^(?:mouse|contextmenu)|click/, yb = /^(?:focusinfocus|focusoutblur)$/, zb = /^([^.]*)(?:\.(.+)|)$/;
    c.event = {global: {}, add: function (a, b, d, e, f) {
        ...
        if (k = c._data(a)) {
            ...
            b = (b || "").match(O) || [""];
            for (k = b.length; k--;)g = zb.exec(b[k]) || [], u = s = g[1], p = (g[2] || "").split(".").sort(), g = c.event.special[u] || {}, u = (f ? g.delegateType : g.bindType) || u, g = c.event.special[u] || {}, s = c.extend({type: u, origType: s, data: e, handler: d, guid: d.guid,
                selector: f, needsContext: f && c.expr.match.needsContext.test(f), namespace: p.join(".")}, l), (m = h[u]) || (m = h[u] = [], m.delegateCount = 0, g.setup && !1 !== g.setup.call(a, e, p, q) || (a.addEventListener ? a.addEventListener(u, q, !1) : a.attachEvent && a.attachEvent("on" + u, q))), g.add && (g.add.call(a, s), s.handler.guid || (s.handler.guid = d.guid)), f ? m.splice(m.delegateCount++, 0, s) : m.push(s), c.event.global[u] = !0;
            a = null
        }
        ...
        if (z && (n = z.events)) {
            b = (b || "").match(O) ||
                [""];
            for (q = b.length; q--;)if (k = zb.exec(b[q]) || [], E = A = k[1], r = (k[2] || "").split(".").sort(), E) {
                m = c.event.special[E] || {};
            ...
            } else for (E in n)c.event.remove(a, E + b[q], d, e, !0);
            c.isEmptyObject(n) && (delete z.handle, c._removeData(a, "events"))
        }
    }, trigger: function (a, b, d, e) {
        var f, g, h, k, l, q, s = [d || p], m = ga.call(a, "type") ? a.type : a;
        ...
        if (3 !== d.nodeType && 8 !== d.nodeType && !yb.test(m + c.event.triggered) && (0 <= m.indexOf(".") && (l = m.split("."), m = l.shift(), l.sort()), g = 0 > m.indexOf(":") && "on" + m, a = a[c.expando] ? a : new c.Event(m, "object" === typeof a && a), a.isTrigger = !0,
            ...
            for (q = 0; (h = s[q++]) && !a.isPropagationStopped();)a.type = 1 < q ? k : l.bindType ||
        ...
        a = c.event.fix(a);
        var b, d, e, f, g = [], h = U.call(arguments);
        ...
        if (!k.preDispatch || !1 !== k.preDispatch.call(this, a)) {
            ...
            for (b = 0; (e = g[b++]) && !a.isPropagationStopped();)for (a.currentTarget = e.elem, f = 0; (d = e.handlers[f++]) && !a.isImmediatePropagationStopped();)if (!a.namespace_re || a.namespace_re.test(d.namespace))a.handleObj = d, a.data = d.data, d = ((c.event.special[d.origType] || {}).handle || d.handler).apply(e.elem, h), d !== n && !1 === (a.result =
        ...
        k < b.length &&
        h.push({elem: this, handlers: b.slice(k)});
        return h
    }, fix: function (a) {
    ...
    c.Event.prototype = {isDefaultPrevented: J, isPropagationStopped: J, isImmediatePropagationStopped: J,
    ...
    c.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (a, b) {
        c.event.special[a] = {delegateType: b, bindType: b, handle: function (a) {
            var e,
                f = a.relatedTarget, g = a.handleObj;
    ...
    c.fn.extend({on: function (a, b, d, e, f) {
        ...
        if (!1 === e)e = J; else if (!e)return this;
    ...
    (function (a, b) {
        ...
        function h(a, b, c, d) {
            ...
            if (!x && !d) {
                if (e = ka.exec(a))if (g = e[1])if (9 === h)if ((f = b.getElementById(g)) && f.parentNode) {
            ...
            a:{
                ...
                if (!d && 1 === f.length) {
                    ...
                    for (h = Y.needsContext.test(a) ? 0 : e.length; h--;) {
                        ...
                        if (g = t.find[g])if (d = g(q.matches[0].replace(ca, da), ba.test(e[0].type) && b.parentNode || b)) {
                            e.splice(h, 1);
                            a = d.length && p(e);
                            if (!a) {
        ...
        function m(a, b) {
            ...
            for (l = t.preFilter; g;) {
                ...
                c = !1;
                if (d = fa.exec(g))c = d.shift(), e.push({value: c, type: d[0].replace(P, " ")}), g = g.slice(c.length);
                for (f in t.filter)!(d = Y[f].exec(g)) || l[f] && !(d = l[f](d)) || (c = d.shift(), e.push({value: c, type: f, matches: d}), g = g.slice(c.length));
                if (!c)break
            }
        ...
        function r(a, b, c) {
            ...
            return b.first ? function (b, c, f) {
                ...
                } else for (; b = b[d];)if (1 === b.nodeType || e)if (Ja = b[w] || (b[w] = {}), (k = Ja[d]) && k[0] === l) {
        ...
        function A(a, b, c, d, e) {
            for (var f,
                     g = [], h = 0, k = a.length, l = null != b; h < k; h++)if (f = a[h])if (!c || c(f, d, e))g.push(f), l && b.push(h);
            return g
        }
        ...
        function F(a, b, c, d, e, g) {
            ...
            return f(function (f, g, k, l) {
                ...
                u = c ? e || (f ? a : s || d) ? [] : g : r;
                c && c(r, u, k, l);
                if (d)for (m = A(u, p), d(m, [], k, l), k = m.length; k--;)if (q = m[k])u[p[k]] = !(r[p[k]] = q);
                if (f) {
                    if (e || a) {
                        if (e) {
                            m = [];
        ...
        function y(a) {
            var b, c, d, e = a.length, f = t.relative[a[0].type];
            c = f || t.relative[" "];
            ...
            }]; g < e; g++)if (c = t.relative[a[g].type])l = [r(z(l), c)]; else {
        ...
        function O(a, b) {
            var c = 0, d = 0 < b.length, e = 0 < a.length, g = function (f, g, k, l, m) {
                var q, n, p = [], s = 0, u = "0", r = f && [], E = null != m, ua = wa, qa = f || e && t.find.TAG("*", m && g.parentNode || g), w = D += null == ua ? 1 : Math.random() || 0.1;
                E && (wa = g !== K && g, v = c);
                for (; null != (m = qa[u]); u++) {
                    if (e && m) {
                        for (q = 0; n = a[q++];)if (n(m, g, k)) {
                            l.push(m);
                            break
                        }
                        E &&
                ...
                if (d && u !== s) {
                    ...
                    if (f) {
                        if (0 < s)for (; u--;)r[u] || p[u] || (p[u] = aa.call(l));
                        p = A(p)
                    }
                    G.apply(l, p);
        ...
        var pa, v, t, qa, Ab, Ka, ra, wa, oa, K, N, x, V, sa, H, I, L, w = "sizzle" + -new Date, ha = a.document, C = {}, D = 0, W = 0, Q = e(), R = e(), S = e(), $ = typeof b, U = -2147483648, B = [], aa = B.pop, G = B.push, J = B.slice, T = B.indexOf || function (a) {
                for (var b = 0, c = this.length; b < c; b++)if (this[b] ===
                    a)return b;
                return-1
            }, B = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w", "w#"), Z = "\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + B + ")|)|)[\\x20\\t\\r\\n\\f]*\\]", X = ":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + Z.replace(3, 8) + ")*)|.*)\\)|)", P = RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$", "g"), ea = /^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,
        ...
        qa = h.getText = function (a) {
            var b, c = "", d = 0;
            b = a.nodeType;
            if (!b)for (; b = a[d]; d++)c += qa(b); else if (1 === b || 9 === b || 11 === b) {
                if ("string" === typeof a.textContent)return a.textContent;
                for (a = a.firstChild; a; a = a.nextSibling)c += qa(a)
            } else if (3 === b || 4 === b)return a.nodeValue;
            return c
        };
        t = h.selectors = {cacheLength: 50, createPseudo: f, match: Y, find: {}, relative: {">": {dir: "parentNode", first: !0}, " ": {dir: "parentNode"}, "+": {dir: "previousSibling", first: !0}, "~": {dir: "previousSibling"}}, preFilter: {ATTR: function (a) {
            a[1] =
                a[1].replace(ca, da);
            ...
            a[4] ? a[2] = a[4] : c && (ga.test(c) && (b = m(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length)) && (a[0] = a[0].slice(0, b),
                a[2] = c.slice(0, b));
            return a.slice(0, 3)
            ...
            return 1 === d && 0 === e ? function (a) {
                ...
                var s = b.parentNode, u = h && b.nodeName.toLowerCase();
                k = !k && !h;
                if (s) {
                    if (f) {
                        for (; c;) {
                            for (m =
                                     b; m = m[c];)if (h ? m.nodeName.toLowerCase() === u : 1 === m.nodeType)return!1;
                            p = c = "only" === a && !p && "nextSibling"
                        }
                        return!0
                    }
                    p = [g ? s.firstChild : s.lastChild];
                    if (g && k)for (k = s[w] || (s[w] = {}), l = k[a] || [], n = l[0] === D && l[1], q = l[0] === D && l[2], m = n && s.childNodes[n]; m = ++n && m && m[c] || (q = n = 0) || p.pop();) {
                        if (1 === m.nodeType && ++q && m === b) {
                            k[a] = [D, n, q];
                            break
                        }
                    } else if (k && (l = (b[w] || (b[w] = {}))[a]) && l[0] === D)q = l[1]; else for (; (m = ++n && m && m[c] || (q = n = 0) || p.pop()) && ((h ? m.nodeName.toLowerCase() !== u : 1 !== m.nodeType) || !++q || (k && ((m[w] || (m[w] = {}))[a] =
                        [D, q]), m !== b)););
                    q -= e;
            ...
            var b = [], c = [], d = Ka(a.replace(P, "$1"));
            return d[w] ? f(function (a, b, c, e) {
                e = d(a, null, e, []);
                for (var f = a.length; f--;)if (c =
                    e[f])a[f] = !(b[f] = c)
            }) : function (a, e, f) {
                b[0] = a;
                d(b, null, f, c);
            ...
            return function (b) {
                var c;
                do if (c = x ? b.getAttribute("xml:lang") || b.getAttribute("lang") : b.lang)return c = c.toLowerCase(), c === a || 0 === c.indexOf(a + "-"); while ((b = b.parentNode) &&
                    1 === b.nodeType);
                return!1
            }
        }), target: function (b) {
        ...
        for (pa in{radio: !0, checkbox: !0, file: !0, password: !0, image: !0})t.pseudos[pa] = l(pa);
        for (pa in{submit: !0, reset: !0})t.pseudos[pa] =
            q(pa);
    ...
    var rc = /Until$/, sc = /^(?:parents|prev(?:Until|All))/, Tb = /^.[^:#\[\.,]*$/, Bb = c.expr.match.needsContext, tc = {children: !0,
        contents: !0, next: !0, prev: !0};
    c.fn.extend({find: function (a) {
        ...
        for (var d, e = 0, f = this.length, g = [], h = Bb.test(a) || "string" !== typeof a ? c(a, b || this.context) : 0; e < f; e++)for (d = this[e]; d && d.ownerDocument && d !== b && 11 !== d.nodeType;) {
    ...
    var Za = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", uc = / jQuery\d+="(?:null|\d+)"/g, Cb = RegExp("<(?:" + Za + ")[\\s/>]", "i"),
        La = /^\s+/, Db = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Eb = /<([\w:]+)/, Fb = /<tbody/i, vc = /<|&#?\w+;/, wc = /<(?:script|style|link)/i, za = /^(?:checkbox|radio)$/i, xc = /checked\s*(?:[^=]|=\s*.checked.)/i, Gb = /^$|\/(?:java|ecma)script/i, Ub = /^true\/(.*)/, yc = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, F = {option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], area: [1, "<map>", "</map>"], param: [1, "<object>", "</object>"], thead: [1, "<table>", "</table>"],
            tr: [2, "<table><tbody>", "</tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: c.support.htmlSerialize ? [0, "", ""] : [1, "X<div>", "</div>"]}, Ma = Ya(p).appendChild(p.createElement("div"));
    F.optgroup = F.option;
    ...
    c.fn.extend({text: function (a) {
        ...
        for (var d, e = 0; null != (d = this[e]); e++)if (!a || 0 < c.filter(a, [d]).length)b || 1 !== d.nodeType || c.cleanData(A(d)), d.parentNode && (b && c.contains(d.ownerDocument, d) &&
        ...
        a = sb.apply([], a);
        var e, f, g, h, k = 0, l = this.length, q = this, p = l - 1, m = a[0], u = c.isFunction(m);
        ...
        if (l && (h = c.buildFragment(a, this[0].ownerDocument, !1, this), e = h.firstChild, 1 === h.childNodes.length && (h = e), e)) {
            ...
            if (f)for (h = g[g.length - 1].ownerDocument, c.map(g, ab), k = 0; k < f; k++)e = g[k], Gb.test(e.type || "") && (!c._data(e, "globalEval") && c.contains(h, e)) && (e.src ? c.ajax({url: e.src, type: "GET", dataType: "script", async: !1, global: !1, "throws": !0}) :
    ...
    c.extend({clone: function (a, b, d) {
        ...
        if (!(c.support.noCloneEvent && c.support.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || c.isXMLDoc(a)))for (e = A(g), k = A(a), h = 0; null != (f = k[h]); ++h)if (e[h]) {
            ...
            if (1 === q.nodeType) {
                ...
                if ("script" === n && q.text !== f.text)$a(q).text =
                    f.text, ab(q); else if ("object" === n)q.parentNode && (q.outerHTML = f.outerHTML), c.support.html5Clone && (f.innerHTML && !c.trim(q.innerHTML)) && (q.innerHTML = f.innerHTML); else if ("input" === n && za.test(f.type))q.defaultChecked = q.checked = f.checked, q.value !== f.value && (q.value = f.value); else if ("option" === n)q.defaultSelected = q.selected = f.defaultSelected; else if ("input" === n || "textarea" === n)q.defaultValue = f.defaultValue
            }
        }
        if (b)if (d)for (k = k || A(a), e = e || A(g), h = 0; null != (f = k[h]); h++)bb(f, e[h]); else bb(a, g);
        e = A(g, "script");
        0 < e.length && ya(e, !l && A(a, "script"));
        return g
    }, buildFragment: function (a, b, d, e) {
        for (var f, g, h, k, l, q, n = a.length, m = Ya(b), p = [], r = 0; r < n; r++)if ((g = a[r]) || 0 === g)if ("object" === c.type(g))c.merge(p, g.nodeType ? [g] : g); else if (vc.test(g)) {
        ...
        for (r = 0; g = p[r++];)if (!e || -1 === c.inArray(g, e))if (a = c.contains(g.ownerDocument, g), h = A(m.appendChild(g), "script"), a && ya(h),
            d)for (f = 0; g = h[f++];)Gb.test(g.type || "") && d.push(g);
        return m
    }, cleanData: function (a, b) {
        for (var d, e, f, g, h = 0, k = c.expando, l = c.cache, q = c.support.deleteExpando, n = c.event.special; null != (d = a[h]); h++)if (b || c.acceptData(d))if (g = (f = d[k]) && l[f]) {
    ...
    var ea, R, S, Na = /alpha\([^)]*\)/i, zc = /opacity\s*=\s*([^)]*)/, Ac = /^(top|right|bottom|left)$/,
        Bc = /^(none|table(?!-c[ea]).+)/, Hb = /^margin/, Wb = RegExp("^(" + na + ")(.*)$", "i"), ba = RegExp("^(" + na + ")(?!px)[a-z%]+$", "i"), Cc = RegExp("^([+-])=(" + na + ")", "i"), jb = {BODY: "block"}, Dc = {position: "absolute", visibility: "hidden", display: "block"}, Ib = {letterSpacing: 0, fontWeight: 400}, Q = ["Top", "Right", "Bottom", "Left"], db = ["Webkit", "O", "Moz", "ms"];
    ...
    }}}, cssNumber: {columnCount: !0, fillOpacity: !0, fontWeight: !0, lineHeight: !0, opacity: !0, orphans: !0, widows: !0, zIndex: !0, zoom: !0}, cssProps: {"float": c.support.cssFloat ? "cssFloat" :
    ...
    r.getComputedStyle ?
        (R = function (a) {
            ...
            var e, f = (d = d || R(a)) ? d.getPropertyValue(b) || d[b] : n, g = a.style;
        ...
        var e, f, g = (c = c || R(a)) ? c[b] : n, h = a.style;
        null == g && (h && h[b]) && (g = h[b]);
        if (ba.test(g) && !Ac.test(b)) {
            c = h.left;
    ...
    c(function () {
        ...
        (c.cssHooks.marginRight = {get: function (a, b) {
            if (b)return c.swap(a, {display: "inline-block"}, S, [a, "marginRight"])
        }});
    ...
    var aa, W, Oa = c.now(), Pa = /\?/, Hc = /#.*$/, Kb = /([?&])_=[^&]*/, Ic = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, Jc = /^(?:GET|HEAD)$/, Kc = /^\/\//, Lb = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Mb = c.fn.load, Nb = {}, Ba = {}, Ob = "*/".concat("*");
    try {
        W = $b.href
    } catch (Pc) {
    ...
    c.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: W, type: "GET", isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(aa[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": Ob, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"},
        contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": r.String, "text html": !0, "text json": c.parseJSON, "text xml": c.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (a, b) {
        return b ? Ca(Ca(a, c.ajaxSettings), b) : Ca(c.ajaxSettings, a)
    }, ajaxPrefilter: lb(Nb), ajaxTransport: lb(Ba), ajax: function (a, b) {
        function d(a, b, d, e) {
            var f, p, s, t, x = b;
            if (2 !== M) {
                M = 2;
                ...
                if (d) {
                    ...
                    var B, y, H, I, G = t.contents,
                        w = t.dataTypes, J = t.responseFields;
                    for (I in J)I in d && (e[J[I]] = d[I]);
                    for (; "*" === w[0];)w.shift(), y === n && (y = t.mimeType || e.getResponseHeader("Content-Type"));
                    if (y)for (I in G)if (G[I] && G[I].test(y)) {
                        w.unshift(I);
                        break
                    }
                    if (w[0]in d)H = w[0]; else {
                        for (I in d) {
                ...
                if (200 <= a && 300 > a || 304 === a)if (m.ifModified && ((d = v.getResponseHeader("Last-Modified")) && (c.lastModified[g] = d), (d = v.getResponseHeader("etag")) && (c.etag[g] =
                    d)), 204 === a)f = !0, x = "nocontent"; else if (304 === a)f = !0, x = "notmodified"; else {
                    a:{
                        p = m;
                        s = t;
                        var C, D, x = {};
                        ...
                        if (y[1])for (D in p.converters)x[D.toLowerCase()] = p.converters[D];
                        for (; d = y[++B];)if ("*" !== d) {
                            if ("*" !== H && H !== d) {
                                D = x[H + " " + d] || x["* " + d];
                                if (!D)for (C in x)if (f = C.split(" "), f[1] === d && (D = x[H + " " + f[0]] || x["* " + f[0]])) {
                                    !0 === D ? D = x[C] : !0 !== x[C] && (d = f[0], y.splice(B--, 0, d));
                                    break
                                }
                                if (!0 !== D)if (D && p["throws"])s = D(s); else try {
                                    s = D(s)
                                } catch (L) {
                                    f =
                                    {state: "parsererror", error: D ? L : "No conversion from " + H + " to " + d};
                                    break a
                                }
                            }
                            H = d
                        }
                        f = {state: "success", data: s}
                    }
                    x = f.state;
                    p = f.data;
                    s = f.error;
        ...
        var e, f, g, h, k, l, q, p, m = c.ajaxSetup({},
            b), r = m.context || m, E = m.context && (r.nodeType || r.jquery) ? c(r) : c.event, z = c.Deferred(), A = c.Callbacks("once memory"), F = m.statusCode || {}, B = {}, y = {}, M = 0, G = "canceled", v = {readyState: 0, getResponseHeader: function (a) {
            var b;
            if (2 === M) {
                if (!p)for (p = {}; b = Ic.exec(h);)p[b[1].toLowerCase()] = b[2];
                b = p[a.toLowerCase()]
            }
            ...
            var b;
            if (a)if (2 > M)for (b in a)F[b] = [F[b], a[b]]; else v.always(a[v.status]);
            return this
        }, abort: function (a) {
            a = a || G;
            q && q.abort(a);
        ...
        if (m.beforeSend && (!1 === m.beforeSend.call(r, v, m) ||
            2 === M))return v.abort();
        G = "abort";
        for (f in{success: 1, error: 1, complete: 1})v[f](m[f]);
        if (q = mb(Ba, m, b, v)) {
            v.readyState = 1;
    ...
    var X, ia, Lc = 0, Ra = r.ActiveXObject && function () {
        ...
        if (!a.crossDomain || c.support.cors) {
            ...
            return{send: function (d, e) {
                ...
                b = function (d, g) {
                    var k, m, p, r;
                    try {
                        if (b && (g || 4 === h.readyState))if (b = n, f && (h.onreadystatechange = c.noop, Ra && delete X[f]), g)4 !== h.readyState && h.abort(); else {
                            r = {};
                            k = h.status;
    ...
    var T, ta, Mc = /^(?:toggle|show|hide)$/, Nc = RegExp("^(?:([+-])=|)(" + na + ")([a-z%]*)$", "i"), Oc = /queueHooks$/, ja = [function (a, b, d) {
        var e, f, g, h, k, l, q = this, n = a.style, m = {}, p =
            [], r = a.nodeType && P(a);
        ...
        if (b = p.length)for (g = c._data(a, "fxshow") || c._data(a, "fxshow", {}), ("hidden"in g) && (r = g.hidden), e && (g.hidden = !r), r ? c(a).show() : q.done(function () {
            c(a).hide()
        }), q.done(function () {
            var b;
        ...
        var d, e, f = this.createTween(a, b), g = Nc.exec(b), h = f.cur(), k = +h || 0, l = 1, n = 20;
        if (g) {
            d = +g[2];
    ...
    c.Animation = c.extend(pb, {tweener: function (a, b) {
    ...
    c.Tween = z;
    z.prototype = {constructor: z, init: function (a, b, d, e, f, g) {
        this.elem = a;
        this.prop = d;
        this.easing = f || "swing";
        this.options = b;
    ...
    z.propHooks = {_default: {get: function (a) {
        ...
        if (c.fx.step[a.prop])c.fx.step[a.prop](a); else a.elem.style && (null != a.elem.style[c.cssProps[a.prop]] || c.cssHooks[a.prop]) ? c.style(a.elem, a.prop, a.now + a.unit) : a.elem[a.prop] = a.now
    }}};
    ...
    c.each(["toggle", "show", "hide"], function (a, b) {
        ...
        c.fn[b] = function (a, c, g) {
            return null == a || "boolean" === typeof a ? d.apply(this, arguments) : this.animate(ka(b,
                !0), a, c, g)
        }
    });
    c.fn.extend({fadeTo: function (a, b, c, e) {
        ...
        return this.each(function () {
            ...
            if (g)k[g] && k[g].stop && e(k[g]); else for (g in k)k[g] && (k[g].stop && Oc.test(g)) && e(k[g]);
    ...
    c.each({slideDown: ka("show"), slideUp: ka("hide"), slideToggle: ka("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (a, b) {
    ...
    c.fn.offset = function (a) {
        ...
        if (f) {
            ...
            d = qb(f);
            return{top: e.top + (d.pageYOffset || b.scrollTop) - (b.clientTop || 0), left: e.left + (d.pageXOffset || b.scrollLeft) - (b.clientLeft || 0)}
        }
    };
    c.offset = {setOffset: function (a, b, d) {
        ...
        var f = c(a), g = f.offset(), h = c.css(a, "top"), k = c.css(a, "left"), l = {}, n = {};
    ...
    c.fn.extend({position: function () {
        if (this[0]) {
            ...
            return{top: b.top - d.top - c.css(e, "marginTop", !0), left: b.left - d.left - c.css(e, "marginLeft", !0)}
        }
